...
Something as simple as signaling the last object within a group requires divergent functionality or a custom message, since the QUIC stream itself cannot be utilized.
The decision was made to explicitly 
